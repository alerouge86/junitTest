...
public class RestControllerTest {
	...
	void init (){
		...
		userLoggedSession = new UserLoggedSession();
		userLoggedSession.setPerson(new PersonDto("nameFromSessionMocked"));
		
		
		System.out.println("after init: " + userLoggedSession.getPerson().getNome());
	}
	...
	void ritornaPerson1() throws Exception {
		...
		System.out.println("test: ritornaPerson1()");
